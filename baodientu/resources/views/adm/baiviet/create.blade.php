                ...
                <div class="card-body">
                    ...
                    <form method="POST" action="{{route('baiviet.store')}}" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="tieu_de" id="" value="{{old('tieu_de')}}" class="form-control" placeholder="Nhập tiêu đề" aria-describedby="helpId">
                        </div>

                        <div class="form-group">
                            <label for="">Giới thiệu</label>
                            <input type="text" name="gioi_thieu" id="" value="{{old('gioi_thieu')}}" class="form-control" placeholder="Tối đa 110 ký tự" aria-describedby="helpId">
                        </div>
